...
data class PrisonerSearchRequest(
  ...
  @get:JsonProperty("prisonerIdentifier", required = true) val prisonerIdentifier: kotlin.String,
  ...
  @get:JsonProperty("prisonIds") val prisonIds: kotlin.collections.List<kotlin.String>? = null,
)
