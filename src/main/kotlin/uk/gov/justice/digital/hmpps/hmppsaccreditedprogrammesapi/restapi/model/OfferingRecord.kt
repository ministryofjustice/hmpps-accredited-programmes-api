...
data class OfferingRecord(
  ...
  @get:JsonProperty("prisonId", required = true) val prisonId: kotlin.String,
  ...
  @get:JsonProperty("contact email") val contactEmail: kotlin.String? = null,
  ...
  @get:JsonProperty("secondary contact email") val secondaryContactEmail: kotlin.String? = null,
)
