...
constructor(
  ...
  val allPrisonDetails: Map<String?, String?> = prisonRegisterService.getAllPrisons()
  ...
  fun getReferralsByOrganisationId(
    ...
    val apiContent = content.toApi(prisonersDetails, allPrisonDetails, organisationId)
