...
class AuditService(
  ...
  fun audit(prisonNumber: String, auditAction: String) {
    ...
    createInternalAuditRecord(prisonNumber = prisonNumber, auditAction = AuditAction.SEARCH_FOR_PERSON.name)
    publishAuditEvent(auditAction = AuditAction.SEARCH_FOR_PERSON.name, prisonNumber = prisonNumber)
  }
