...
class ApiExceptionHandlerTest {
  ...
  fun `handleMethodArgumentTypeMismatchException with invalid UUID returns 400 with error response`() {
    ...
    assertThat(response.body?.developerMessage).isEqualTo("Method parameter 'uuid': Failed to convert value of type 'java.lang.String' to required type 'java.util.UUID'; Conversion error")
  }
