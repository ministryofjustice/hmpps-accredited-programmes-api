  ...
  inner class ReplaceAllCoursesTests {
    ...
    fun `processes one row`() {
      ...
      service.replaceAllCourses(
        listOf(
          CourseRecord(name = "Course", description = "Description", identifier = "BNM-SO", audience = "Audience 1", alternateName = "CCC", comments = "A comment"),
        ),
      )
    ...
    fun `processes two rows`() {
      ...
      service.replaceAllCourses(
        listOf(
          CourseRecord(name = "Course 1", identifier = "BNM-SO", description = "Description 1", audience = "${a1.value}, ${a2.value} ", alternateName = "111", comments = "A comment for 1"),
          CourseRecord(name = "Course 2", identifier = "BNM-SX", description = "Description 2", audience = "${a1.value}, ${a3.value}", alternateName = "222", comments = "A comment for 2"),
        ),
      )
    ...
    fun `Duplicate audience values are eliminated`() {
      ...
      service.replaceAllCourses(
        listOf(
          CourseRecord(name = "Course 1", identifier = "BNM-S1", description = "Description 1", audience = "${a1.value}, ${a2.value} ", alternateName = "111", comments = "A comment for 1"),
          CourseRecord(name = "Course 2", identifier = "BNM-S2", description = "Description 2", audience = "${a1.value}, ${a3.value}", alternateName = "222", comments = "A comment for 2"),
          CourseRecord(name = "Course 3", identifier = "BNM-S3", description = "Description 3", audience = a1.value, alternateName = "333", comments = "A comment for 3"),
          CourseRecord(name = "Course 4", identifier = "BNM-S4", description = "Description 4", audience = a1.value, alternateName = "444", comments = "A comment for 4"),
        ),
      )
